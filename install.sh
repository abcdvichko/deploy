...
[[ -z $FASTGIT ]] && GITHUB_RAW_URL="raw.githubusercontent.com" || GITHUB_RAW_URL="raw.githubusercontent.com"
...
[[ -z $FASTGIT ]] && GITHUB_URL="github.com" || GITHUB_URL="raw.githubusercontent.com"
